---
layout: default
description: Concours externe d'administrat·eur·rice de l'Insee — 2023
title: Benjamin GILBERT - Corrections
lang: "fr"
katex: True
---

<h2 style="font-weight: normal; margin-bottom: 10px"><em>Concours externe d'administrat·eur·rice de l'Insee — 2023</em></h2>
...
<ol type="1" start="1">
    <p>
    On note \( V=M_{n}(\mathbb{C}) \) l'espace vectoriel des matrices carrées de taille \( n \times n \) à coefficients complexes et \( E=\mathbb{C}^{n} \) identifié à \( M_{n, 1}(\mathbb{C}) \) pour \(n \geq 2 \).
    <br><br>
    On note par \( \mathrm{tr} \) la trace d'une matrice.
    <br><br>
