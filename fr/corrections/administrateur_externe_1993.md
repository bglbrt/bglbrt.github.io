...
<p style="border: solid 2px; border-radius: 10px; background-color:rgba(49, 140, 231, .1); padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; margin: 15px 0 15px 0px;">
